				...
				<div id="carousel-example" class="carousel slide"
					...
					<div class="carousel-inner">
						<div class="item active">
							<img src="img/slide_03.jpg" alt="First slide" />
							<div class="carousel-caption">
								<h3>Sum</h3>
								<p>Best Suitable for individuals...</p>
								<p>
									<a class="btn btn-clear btn-sm btn-min-block" href="#">More
										Details</a>
								</p>
							</div>
						</div>
						<div class="item">
							<img src="img/slide_02.jpg" alt="Second slide" />
							<div class="carousel-caption">
								<h3>Ware</h3>
								<p>Best Suitable for small businesses</p>
								<p>
									<a class="btn btn-clear btn-sm btn-min-block" href="#">More
										Details</a>
								</p>
						...
						<div class="item">
							<img src="img/slide_01.jpg" alt="Third slide" />
							<div class="carousel-caption">
								<h3>Team</h3>
								<p>Best Suitable for small businesses</p>
								<p>
					...
					<a class="left carousel-control" href="#carousel-example"
						...
						class="fa fa-angle-left" aria-hidden="true"></span>
