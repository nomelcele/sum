...
<script>
	$(function(){
		$('#mytap a:first').click(function (e) {
			  e.preventDefault();
			  $(this).tab('show');
			});
	});
	...
	<div class="col-lg-3">
		...
		<div class="list-group">
			<c:forEach var="memList" items="${list}">
				...
				<a href="sumware?model=messenger&submod=messengerChat&tomemNume=${memList.memnum}&frommemNum=${sessionScope.v.memnum }" class="list-group-item">
<%-- 				<img class="media-object" src="${memList.memprofile }" alt="..." style="width: 10px; height: 10px">				 --%>
				...
				${memList.memname} 
				<span>(${memList.memnum})</span><span> / ${memList.dename}</span></a>
