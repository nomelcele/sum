...
public class LoginDao {
	...
	public MemberVO login(MemberVO v) throws SQLException {
		...
		if (v.getMemnum() == 0) {
			...
			sql.append("select s.memnum, s.memprofile, s.memname, s.memjob , d.dename,s.memdept, nvl(s.memmgr,0) mgrname, s.memauth ");
			...
			sql.append("select s.memnum, s.memprofile, s.memname, s.memjob, d.dename,s.memdept, m.memname mgrname, s.memauth ");
